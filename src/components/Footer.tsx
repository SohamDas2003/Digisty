  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        <Grid container spacing={6} sx={{ mb: 6 }}>
          <Grid size={{ xs: 12, md: 4 }}>
            <Box
              ...
              sx={{ width: { xs: 220, sm: 250 }, height: 'auto', display: 'block', mb: 2 }}
            />
            <Typography
              variant="body2"
              sx={{ color: 'text.secondary', lineHeight: 1.8, mb: 3, maxWidth: 300, fontSize: '0.925rem' }}
            >
              Elevating brands to new heights through data-driven digital marketing
              strategies that deliver real, measurable results.
            </Typography>
            <Typography
              variant="body2"
              sx={{ color: 'text.secondary', lineHeight: 1.6, mb: 3, maxWidth: 300, fontSize: '0.875rem' }}
            >
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <Grid size={{ xs: 6, md: 'auto' }} key={category} sx={{ flexGrow: 1 }}>
              <Typography
                variant="subtitle2"
                sx={{
                  fontWeight: 700,
        ...
        >
          <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.825rem' }}>
            &copy; {new Date().getFullYear()} Digisty Technologies. All rights reserved.
          </Typography>
          <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.825rem' }}>
